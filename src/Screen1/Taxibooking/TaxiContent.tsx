...
//   // In TaxiContent.tsx - Update fetchNearbyDrivers function
...
//       vehicleType: selectedRideType, // Send selected vehicle type
//       limit: 10, // Request only 10 drivers
...
// // Update getDriversToShow function to filter and limit to 10 drivers
...
//   // ADD: Filter by vehicle type and limit to 10 nearest drivers
...
//         // FILTER BY VEHICLE TYPE: Only show drivers with matching vehicle type
...
//     console.log(`✅ Filtered ${selectedRideType} drivers count:`, filteredDrivers.length);
...
//       driverMobile: data.driverMobile || 'N/A',
//       location: {
//         coordinates: [data.driverLng || data.drop?.lng || 0, data.driverLat || data.drop?.lat || 0]
//       },
//       vehicleType: data.vehicleType || selectedRideType,
//       status: "onTheWay"
//     };
...
//     // 🔴 CRITICAL FIX: Always set initial driver location
//     // Use driverLat/driverLng if available, otherwise use pickup coordinates
//     const driverLat = data.driverLat || data.pickup?.lat || 0;
//     const driverLng = data.driverLng || data.pickup?.lng || 0;
...
//         latitude: driverLoc.latitude,
//         longitude: driverLoc.longitude,
//         source: data.driverLat ? 'driverLat/Lng' : 'pickup coordinates'
//       });
